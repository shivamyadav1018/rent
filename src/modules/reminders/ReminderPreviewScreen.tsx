...
export function ReminderPreviewScreen({ route }: any) {
  ...
  return (
    <Screen>
      ...
      <AppButton title="Send on WhatsApp" onPress={() => whatsappShareService.shareMessage(cycle.tenant_phone, message).catch(() => Alert.alert('Could not share reminder', 'Please try again.'))} />
